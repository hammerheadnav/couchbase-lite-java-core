...
import com.couchbase.lite.v1.internal.database.security.Key;
import com.couchbase.lite.v1.internal.database.sqlite.SQLiteConnection;
import com.couchbase.lite.v1.internal.database.sqlite.SQLiteConnectionListener;
import com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabase;
import com.couchbase.lite.v1.internal.database.sqlite.exception.SQLiteConstraintException;
...
public abstract class SQLiteStorageEngineBase implements SQLiteStorageEngine {
    ...
    public boolean open(String path, SymmetricKey encryptionKey) throws SQLException {
        ...
        } catch(com.couchbase.lite.v1.internal.database.SQLException e) {
            hasError = true;
    ...
    private static void decrypt(SQLiteConnection connection, SymmetricKey key)
            throws com.couchbase.lite.v1.internal.database.SQLException {
        if (key != null) {
            try {
    ...
    private class SQLiteCursor implements Cursor {
        private com.couchbase.lite.v1.internal.database.cursor.Cursor cursor;

        public SQLiteCursor(com.couchbase.lite.v1.internal.database.cursor.Cursor cursor) {
            this.cursor = cursor;
        }
