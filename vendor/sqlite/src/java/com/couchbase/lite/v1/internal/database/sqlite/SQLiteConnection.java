...
import com.couchbase.lite.v1.internal.database.sqlite.exception.SQLiteDatabaseLockedException;
 ...
 * object or the {@link com.couchbase.lite.v1.internal.database.sqlite.SQLiteConnectionPool}.  Those classes are
...
public final class SQLiteConnection implements CancellationSignal.OnCancelListener {
    ...
    private final com.couchbase.lite.v1.internal.database.sqlite.SQLiteConnectionPool mPool;
    private final com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabaseConfiguration mConfiguration;
    ...
    private SQLiteConnection(com.couchbase.lite.v1.internal.database.sqlite.SQLiteConnectionPool pool,
                             com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabaseConfiguration configuration,
                             com.couchbase.lite.v1.internal.database.sqlite.SQLiteConnectionListener connectionListener,
                             int connectionId, boolean primaryConnection) {
        mPool = pool;
        mConfiguration = new com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabaseConfiguration(configuration);
        mConnectionListener = connectionListener;
        mConnectionId = connectionId;
        mIsPrimaryConnection = primaryConnection;
        mIsReadOnlyConnection = (configuration.openFlags & com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabase.OPEN_READONLY) != 0;
    }
    ...
    static SQLiteConnection open(com.couchbase.lite.v1.internal.database.sqlite.SQLiteConnectionPool pool,
                                 com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabaseConfiguration configuration,
                                 com.couchbase.lite.v1.internal.database.sqlite.SQLiteConnectionListener connectionListener,
                                 int connectionId, boolean primaryConnection) {
    ...
    private void setPageSize() {
        if (!mConfiguration.isInMemoryDb() && !mIsReadOnlyConnection) {
            final long newValue = com.couchbase.lite.v1.internal.database.sqlite.SQLiteGlobal.getDefaultPageSize();
    ...
    private void setAutoCheckpointInterval() {
        if (!mConfiguration.isInMemoryDb() && !mIsReadOnlyConnection) {
            final long newValue = com.couchbase.lite.v1.internal.database.sqlite.SQLiteGlobal.getWALAutoCheckpoint();
    ...
    private void setJournalSizeLimit() {
        if (!mConfiguration.isInMemoryDb() && !mIsReadOnlyConnection) {
            final long newValue = com.couchbase.lite.v1.internal.database.sqlite.SQLiteGlobal.getJournalSizeLimit();
    ...
    private void setWalModeFromConfiguration() {
        if (!mConfiguration.isInMemoryDb() && !mIsReadOnlyConnection) {
            if ((mConfiguration.openFlags & com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING) != 0) {
                setJournalMode("WAL");
                setSyncMode(com.couchbase.lite.v1.internal.database.sqlite.SQLiteGlobal.getWALSyncMode());
            } else {
                setJournalMode(com.couchbase.lite.v1.internal.database.sqlite.SQLiteGlobal.getDefaultJournalMode());
                setSyncMode(com.couchbase.lite.v1.internal.database.sqlite.SQLiteGlobal.getDefaultSyncMode());
            }
        }
    }
    ...
    // Called by SQLiteConnectionPool only.
    void reconfigure(com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabaseConfiguration configuration) {
        ...
        boolean walModeChanged = ((configuration.openFlags ^ mConfiguration.openFlags)
                & com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING) != 0;
     ...
     * is not null, the provided {@link com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatementInfo} object is populated
     ...
     * @param outStatementInfo The {@link com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatementInfo} object to populate
     * with information about the statement, or null if none.
     *
     * @throws com.couchbase.lite.v1.internal.database.sqlite.exception.SQLiteException if an error occurs, such as a syntax error.
     */
    public void prepare(String sql, com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatementInfo outStatementInfo) {
        if (sql == null) {
    ...
    private void bindArguments(PreparedStatement statement, Object[] bindArgs) {
        ...
        if (count != statement.mNumParameters) {
            throw new com.couchbase.lite.v1.internal.database.sqlite.exception.SQLiteBindOrColumnIndexOutOfRangeException(
    ...
    private void throwIfStatementForbidden(PreparedStatement statement) {
        if (mOnlyAllowReadOnlyOperations && !statement.mReadOnly) {
            throw new com.couchbase.lite.v1.internal.database.sqlite.exception.SQLiteException(
     ...
     */
    void collectDbStats(ArrayList<com.couchbase.lite.v1.internal.database.sqlite.SQLiteDebug.DbStats> dbStatsList) {
     ...
     */
    void collectDbStatsUnsafe(ArrayList<com.couchbase.lite.v1.internal.database.sqlite.SQLiteDebug.DbStats> dbStatsList) {
        dbStatsList.add(getMainDbStatsUnsafe(0, 0, 0));
    }

    private com.couchbase.lite.v1.internal.database.sqlite.SQLiteDebug.DbStats getMainDbStatsUnsafe(int lookaside, long pageCount, long pageSize) {
        ...
        return new com.couchbase.lite.v1.internal.database.sqlite.SQLiteDebug.DbStats(label, pageCount, pageSize, lookaside);
    }
    ...
    private static final class OperationLog {
        ...
        private boolean endOperationDeferLogLocked(int cookie) {
            ...
            if (operation != null) {
                ...
                return com.couchbase.lite.v1.internal.database.sqlite.SQLiteDebug.DEBUG_LOG_SLOW_QUERIES && com.couchbase.lite.v1.internal.database.sqlite.SQLiteDebug.shouldLogSlowQuery(
