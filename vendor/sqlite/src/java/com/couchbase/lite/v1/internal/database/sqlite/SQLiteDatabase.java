...
package com.couchbase.lite.v1.internal.database.sqlite;

import com.couchbase.lite.v1.internal.database.ContentValues;
...
import com.couchbase.lite.v1.internal.database.cursor.Cursor;
import com.couchbase.lite.v1.internal.database.DatabaseErrorHandler;
import com.couchbase.lite.v1.internal.database.SQLException;
import com.couchbase.lite.v1.internal.database.CancellationSignal;
import com.couchbase.lite.v1.internal.database.sqlite.exception.SQLiteDatabaseCorruptException;
import com.couchbase.lite.v1.internal.database.util.DatabaseUtils;
import com.couchbase.lite.v1.internal.database.log.DLog;
import com.couchbase.lite.v1.internal.database.OperationCanceledException;
import com.couchbase.lite.v1.internal.database.util.Pair;
import com.couchbase.lite.v1.internal.database.util.Printer;
import com.couchbase.lite.v1.internal.database.util.TextUtils;
...
public final class SQLiteDatabase extends SQLiteClosable {
    private static final String TAG = DLog.TAG_SQLiteDatabase;
    ...
    private final com.couchbase.lite.v1.internal.database.sqlite.SQLiteConnectionListener mConnectionListener;
    ...
    private final com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabaseConfiguration mConfigurationLocked;
    ...
    public static final int OPEN_READ_MASK = 0x00000001;         // update native code if changing
    ...
    /**
     * Determine whether the native SQLite library supports encryption.
     */
    ...
    private SQLiteDatabase(String path, int openFlags, int walConnectionPoolSize,
                           ...
                           DatabaseErrorHandler errorHandler, com.couchbase.lite.v1.internal.database.sqlite.SQLiteConnectionListener connectionListener) {
        mCursorFactory = cursorFactory;
        mErrorHandler = errorHandler;
        mConfigurationLocked = new com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabaseConfiguration(path, openFlags, walConnectionPoolSize);
     ...
     */
    public void beginTransactionWithListener(com.couchbase.lite.v1.internal.database.sqlite.SQLiteTransactionListener transactionListener) {
    ...
    public void beginTransactionWithListenerNonExclusive(
            com.couchbase.lite.v1.internal.database.sqlite.SQLiteTransactionListener transactionListener) {
        beginTransaction(transactionListener, false);
    }

    private void beginTransaction(com.couchbase.lite.v1.internal.database.sqlite.SQLiteTransactionListener transactionListener,
                                  boolean exclusive) {
        acquireReference();
        try {
     ...
     * {@link #OPEN_READONLY} {@link #CREATE_IF_NECESSARY}.
     *
     ...
     * @throws com.couchbase.lite.v1.internal.database.sqlite.exception.SQLiteException if the database cannot be opened
     */
    ...
    public static SQLiteDatabase openDatabase(
            ...
            DatabaseErrorHandler errorHandler,
            com.couchbase.lite.v1.internal.database.sqlite.SQLiteConnectionListener connectionListener) {
    ...
    /**
     * Set an optional platform support object. This helps SQLiteDatabase optimizing
     * some of their operations.
     * @param supporter platform support object
     */
     ...
     *
     * @throws com.couchbase.lite.v1.internal.database.sqlite.exception.SQLiteException if the database could not be reopened as requested, in which
    ...
    private void open() {
        try {
            openInner();
        } catch (com.couchbase.lite.v1.internal.database.sqlite.exception.SQLiteException ex) {
            if (ex instanceof SQLiteDatabaseCorruptException) {
                try {
                    onCorruption();
                } catch (Exception e) { }
            }
            DLog.e(TAG, "Failed to open database '" + getLabel() + "'.", ex);
            close();
            throw ex;
        }
    }
    ...
    private void openInner() {
        synchronized (mLock) {
            ...
            mConnectionPoolLocked =
                    SQLiteConnectionPool.open(mConfigurationLocked, mConnectionListener);
        }
    ...
    public static SQLiteDatabase create(CursorFactory factory) {
        ...
        return openDatabase(com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabaseConfiguration.MEMORY_DB_PATH,
     ...
     * statement and fill in those values with {@link com.couchbase.lite.v1.internal.database.sqlite.SQLiteProgram#bindString}
     * and {@link com.couchbase.lite.v1.internal.database.sqlite.SQLiteProgram#bindLong} each time you want to run the
     * statement. Statements may not return result sets larger than 1x1.
     *<p>
     * No two threads should be using the same {@link com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatement} at the same time.
     *
     * @param sql The raw SQL statement, may contain ? for unknown values to be
     *            bound later.
     * @return A pre-compiled {@link com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatement} object. Note that
     * {@link com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatement}s are not synchronized, see the documentation for more details.
     */
    public com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatement compileStatement(String sql) throws SQLException {
        acquireReference();
        try {
            return new com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatement(this, sql, null);
        } finally {
            releaseReference();
        }
    }
    ...
    public Cursor rawQueryWithFactory(
        ...
        acquireReference();
        try {
            com.couchbase.lite.v1.internal.database.sqlite.SQLiteCursorDriver driver = new com.couchbase.lite.v1.internal.database.sqlite.SQLiteDirectCursorDriver(this, sql, editTable,
                    cancellationSignal);
    ...
    public long insertWithOnConflict(String table, String nullColumnHack,
        ...
        try {
            ...
            com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatement statement = new com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatement(this, sql.toString(), bindArgs);
            try {
    ...
    public int delete(String table, String whereClause, String[] whereArgs) {
        acquireReference();
        try {
            com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatement statement =  new com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatement(this, "DELETE FROM " + table +
    ...
    private int executeSql(String sql, Object[] bindArgs) throws SQLException {
        ...
        try {
            ...
            com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatement statement = new com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatement(this, sql, bindArgs);
            try {
                return statement.executeUpdateDelete();
            } finally {
                statement.close();
    ...
    /**
     * Sets the locale for this database. This will be used by JSON Collator.
     *
     ...
     * {@link #beginTransactionWithListenerNonExclusive(com.couchbase.lite.v1.internal.database.sqlite.SQLiteTransactionListener)}
    ...
    public boolean enableWriteAheadLogging() {
        synchronized (mLock) {
            ...
            if (mHasAttachedDbsLocked) {
                //if (DLog.isLoggable(TAG, DLog.DEBUG)) {
                DLog.d(TAG, "this database: " + mConfigurationLocked.label
     ...
     * Used by bug report.
     */
    static ArrayList<com.couchbase.lite.v1.internal.database.sqlite.SQLiteDebug.DbStats> getDbStats() {
        ArrayList<com.couchbase.lite.v1.internal.database.sqlite.SQLiteDebug.DbStats> dbStatsList = new ArrayList<com.couchbase.lite.v1.internal.database.sqlite.SQLiteDebug.DbStats>();
    ...
    private void collectDbStats(ArrayList<com.couchbase.lite.v1.internal.database.sqlite.SQLiteDebug.DbStats> dbStatsList) {
        synchronized (mLock) {
    ...
    public boolean isDatabaseIntegrityOk() {
        ...
        try {
            ...
            } catch (com.couchbase.lite.v1.internal.database.sqlite.exception.SQLiteException e) {
            ...
            for (int i = 0; i < attachedDbs.size(); i++) {
                ...
                com.couchbase.lite.v1.internal.database.sqlite.SQLiteStatement prog = null;
                try {
                    prog = compileStatement("PRAGMA " + p.first + ".integrity_check(1);");
                    String rslt = prog.simpleQueryForString();
                    if (!rslt.equalsIgnoreCase("ok")) {
                        // integrity_checker failed on main or attached databases
                        DLog.e(TAG, "PRAGMA integrity_check on " + p.second + " returned: " + rslt);
                        return false;
                    }
                } finally {
    ...
    public interface CursorFactory {
        public Cursor newCursor(SQLiteDatabase db,
                                com.couchbase.lite.v1.internal.database.sqlite.SQLiteCursorDriver masterQuery, String editTable,
                                SQLiteQuery query);
    }
