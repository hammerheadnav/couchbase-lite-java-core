...
import com.couchbase.lite.v1.internal.database.util.PrefixPrinter;
 ...
 * operations invokving SQLite can throw {@link com.couchbase.lite.v1.internal.database.sqlite.exception.SQLiteException} or other
...
public final class SQLiteConnectionPool implements Closeable {
    private static final String TAG = DLog.TAG_SQLiteConnectionPool;
    ...
    private SQLiteConnectionPool(com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabaseConfiguration configuration,
     ...
     *
     * @throws com.couchbase.lite.v1.internal.database.sqlite.exception.SQLiteException if a database error occurs.
     */
    public static SQLiteConnectionPool open(com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabaseConfiguration configuration,
                                            com.couchbase.lite.v1.internal.database.sqlite.SQLiteConnectionListener connectionListener) {
    ...
    private void dispose(boolean finalized) {
        if (!finalized) {
            ...
            synchronized (mLock) {
                ...
                if (pendingCount != 0) {
                    DLog.i(TAG, "The connection pool for " + mConfiguration.label
     ...
     * @throws IllegalStateException if the pool has been closed.
     */
    public void reconfigure(com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabaseConfiguration configuration) {
        if (configuration == null) {
            throw new IllegalArgumentException("configuration must not be null.");
        }
    ...
    private boolean recycleConnectionLocked(SQLiteConnection connection,
        ...
        if (status == AcquiredConnectionStatus.RECONFIGURE) {
            try {
                ...
                DLog.e(TAG, "Failed to reconfigure released connection, closing it: "
                        + connection, ex);
     ...
     */
    public void collectDbStats(ArrayList<com.couchbase.lite.v1.internal.database.sqlite.SQLiteDebug.DbStats> dbStatsList) {
        synchronized (mLock) {
    ...
    // Might throw.
    private SQLiteConnection openConnectionLocked(com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabaseConfiguration configuration,
                                                  boolean primaryConnection) {
        final int connectionId = mNextConnectionId++;
        return SQLiteConnection.open(this, configuration, mConnectionListener,
    ...
    void onConnectionLeaked() {
        ...
        DLog.w(TAG, "A SQLiteConnection object for database '"
    ...
    private void reconfigureAllConnectionsLocked() {
        if (mAvailablePrimaryConnection != null) {
            try {
                ...
                DLog.e(TAG, "Failed to reconfigure available primary connection, closing it: "
        ...
        for (int i = 0; i < count; i++) {
            ...
            try {
                ...
                DLog.e(TAG, "Failed to reconfigure available non-primary connection, closing it: "
                        + connection, ex);
                closeConnectionAndLogExceptionsLocked(connection);
    ...
    private void setMaxConnectionPoolSizeLocked(int walConnectionPoolSize) {
        if ((mConfiguration.openFlags & com.couchbase.lite.v1.internal.database.sqlite.SQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING) != 0) {
            if (walConnectionPoolSize > 0)
                ...
                mMaxConnectionPoolSize = com.couchbase.lite.v1.internal.database.sqlite.SQLiteGlobal.getWALConnectionPoolSize();
        } else {
    ...
    private long uptimeMillis() {
        try {
            Class clazz = Class.forName("android.os.SystemClock");
            Method method = clazz.getMethod("uptimeMillis", (Class<?>[])null);
            Long value = (Long) method.invoke(null,(Object[]) null);
            if (value != null)
